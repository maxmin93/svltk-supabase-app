...
CREATE INDEX blog_post_content_idx ON blog."Post" (content);
...
-- AddForeignKey
ALTER TABLE "blog"."Post" ADD CONSTRAINT "Post_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "blog"."User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
